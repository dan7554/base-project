...
/******/ 	var hotCurrentHash = "8d96d6401882cbad455a"; // eslint-disable-line no-unused-vars
...
var _ReactRoot = __webpack_require__(77);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: store },
  _react2.default.createElement(_ReactRoot2.default, null)
...
(function () {
  ...
  reactHotLoader.register(logger, 'logger', 'D:/base-project/src/index.js');
  reactHotLoader.register(middleware, 'middleware', 'D:/base-project/src/index.js');
  reactHotLoader.register(store, 'store', 'D:/base-project/src/index.js');
  leaveModule(module);
})();
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(18),B=__webpack_require__(5),C=__webpack_require__(3),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(7);
...
var ReactRoot = function (_Component) {
    _inherits(ReactRoot, _Component);

    function ReactRoot() {
        _classCallCheck(this, ReactRoot);

        return _possibleConstructorReturn(this, (ReactRoot.__proto__ || Object.getPrototypeOf(ReactRoot)).apply(this, arguments));
    }
    ...
    _createClass(ReactRoot, [{
        ...
        value: function renderContent() {
            return _react2.default.createElement(_Login2.default, { store: this.props.store });
        }
    }, {
        key: 'renderFooter',
...
(function () {
    ...
    reactHotLoader.register(ReactRoot, 'ReactRoot', 'D:/base-project/src/components/ReactRoot.js');
    reactHotLoader.register(_default, 'default', 'D:/base-project/src/components/ReactRoot.js');
    leaveModule(module);
})();
...
function mapDispatchToProps(dispatch) {
    return {
        submitUser: function submitUser(value) {
            return dispatch((0, _User.submitUser)(value));
        },
        submitUserAsync: function submitUserAsync(value) {
            return dispatch((0, _User.submitUserAsync)(value));
        }
    };
}

var Login = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = function (_Component) {
    ...
    function Login(props) {
        ...
        Object.defineProperty(_this, 'handleUserChange', {
            enumerable: true,
            writable: true,
        ...
        Object.defineProperty(_this, 'handlePasswordChange', {
            enumerable: true,
            writable: true,
            value: function value(event) {
        ...
        Object.defineProperty(_this, 'onSubmit', {
            ...
            writable: true,
            value: function value(event) {
                console.log('Submit', _this.state.user, _this.state.password, _this.props);
                _this.props.submitUser(_this.state.user);
            }
        });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    null,
                    _Login2.default.username,
                    _react2.default.createElement('input', { value: this.state.user, onChange: this.handleUserChange })
                ),
                _react2.default.createElement(
                    'span',
                    null,
...
exports.submitUserAsync = submitUserAsync;
...
// Action Prefix
var _PREFIX = 'base/user/';

// Actions
var SUBMIT = _PREFIX + 'SUBMIT';
var CREATE = _PREFIX + 'CREATE';
var REMOVE = _PREFIX + 'REMOVE';
...
function userReducer() {
    ...
    switch (action.type) {
        case SUBMIT:
            return _extends({}, state, { user: { submitting: true, userCred: value } });
        case CREATE:
            return _extends({}, state, { user: { created: true } });
        case REMOVE:
            return _extends({}, state, { user: { removed: true } });
        default:
            return state;
    }
}
...
function submitUserAsync(userCred) {

    return function (dispatch) {
        (0, _isomorphicFetch2.default)('http://www.dchristiani.com', {
            method: 'get',
            mode: 'no-cors',
            headers: {}
        }).then(function (res, a) {
...
var levenshtein = _interopDefault(__webpack_require__(87));
var PropTypes = _interopDefault(__webpack_require__(14));
var hoistNonReactStatic = _interopDefault(__webpack_require__(31));
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;(function() {
  ...
  // amd
  if ("function" !== "undefined" && __webpack_require__(88) !== null && __webpack_require__(89)) {
...
var _Login = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./ducks/Login\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
(function () {
  ...
  reactHotLoader.register(_default, 'default', 'D:/base-project/src/redux/reducer.js');
  leaveModule(module);
})();
